...
export default [
  {
    id: 'addresses-address-total-generic-dormant-exchange-byron-address_6b3e82c0e4fc',
    ...
    response: {
      ...
      received_sum: [{ unit: 'lovelace', quantity: expect.toBeGreaterThan('20180619991547028') }],
      sent_sum: [{ unit: 'lovelace', quantity: expect.toBeGreaterThan('20180619991547028') }],
      tx_count: expect.toBeGreaterThan(150_965),
    },
  },
  {
    id: 'addresses-address-total-generic-shelley-address_9a435f35c611',
    ...
    response: {
      ...
      received_sum: [{ unit: 'lovelace', quantity: expect.toBeGreaterThanOrEqual('2430412032') }],
      sent_sum: [{ unit: 'lovelace', quantity: expect.toBeGreaterThanOrEqual('2430412032') }],
      tx_count: expect.toBeGreaterThanOrEqual(6),
    },
  },
  {
    id: 'addresses-address-total-generic-shelley-address-payment-cred_eb0c5f349038',
