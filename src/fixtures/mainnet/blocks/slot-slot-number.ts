...
export default [
  {
    id: 'blocks-slot-slot-number-generic-shelley_6cb3d2ece078_1',
    testName: 'blocks/slot/:slot_number - generic shelley',
    endpoints: ['blocks/slot/16019999'],
    response: {
      time: 1_607_586_290,
      height: 5_058_628,
  ...
  {
    id: 'blocks-epoch-epoch-number-slot-slot-number-generic-shelley_6cb3d2ece078_2',
    testName: 'blocks/epoch/:epoch_number/slot/:slot_number - generic shelley',
    endpoints: ['blocks/epoch/234/slot/295199'],
    response: {
      time: 1_607_586_290,
      height: 5_058_628,
      hash: '5d3df361b77ba7aff50a00ace1f00cec23126aa3b67af775dbf70c88c7e85ca4',
