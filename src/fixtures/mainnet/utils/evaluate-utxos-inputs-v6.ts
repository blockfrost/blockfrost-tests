...
export const CBOR_ONLY_TX_V6 = {
  postBody: JSON.stringify({
    transaction: {
      cbor: SUCCESS_TX.postBody,
    },
  }),
  headers: { 'Content-Type': 'application/json' } as const,
};

export const MISSING_UTXO_SET_TX_V6 = {
  postBody: JSON.stringify({
    transaction: {
...
export const ADDITIONAL_UTXO_SUCCESS_TX_V6 = {
  postBody: JSON.stringify({
    transaction: {
...
export const ADDITIONAL_UTXO_SET_TX_V6 = {
  postBody: JSON.stringify({
    transaction: {
      cbor: SPENT_UTXO_TX.postBody,
    },
