...
export default [
  ...
  },
  {
    ...
    response: {
      ...
      min_utxo: '4310',
      min_pool_cost: '340000000',
      nonce: '940d01dc4c46490ae4f272f454a51cb13ec466cccfbf6c3da1759a54e540f520',
      cost_models: {
        PlutusV1: {
    ...
    response: {
      ...
      cost_models_raw: {
        PlutusV1: [
          ...
          100181, 726, 719, 0, 1, 100181, 726, 719, 0, 1, 107878, 680, 0, 1, 95336, 1, 281145, 18848,
          0, 1, 180194, 159, 1, 1, 158519, 8942, 0, 1, 159378, 8813, 0, 1, 107490, 3298, 1, 106057,
          655, 1, 1964219, 24520, 3, 607153, 231697, 53144, 0, 1, 116711, 1957, 4, 231883, 10, 1000,
          24838, 7, 1, 232010, 32, 321837444, 25087669, 18, 617887431, 67302824, 36, 356924, 18413,
          45, 21, 219951, 9444, 1, 1000, 172116, 183150, 6, 24, 21, 213283, 618401, 1998, 28258, 1,
          1000, 38159, 2, 22, 1000, 95933, 1, 1, 11, 1000, 277577, 12, 21,
        ],
        PlutusV2: [
          100788, 420, 1, 1, 1000, 173, 0, 1, 1000, 59957, 4, 1, 11183, 32, 201305, 8356, 4, 16000,
          100, 16000, 100, 16000, 100, 16000, 100, 16000, 100, 16000, 100, 100, 100, 16000, 100,
