...
export default [
  ...paginationFixtures,
  {
    ...
    response: [
      ...
      {
        pool_id: 'pool17wdfwsyksx7femcxzx7ycf84maqvdf3fmr7z92h2xguy7eanvdf',
        hex: 'f39a97409681bc9cef0611bc4c24f5df40c6a629d8fc22aaea32384f',
        active_stake: expect.toBeGreaterThan('0'),
        live_stake: expect.toBeGreaterThan('0'),
        live_saturation: expect.toBeGreaterThan(0),
        blocks_minted: expect.toBeGreaterThan(14100),
        margin_cost: 0.0,
        fixed_cost: '340000000',
        declared_pledge: '19000000000',
        metadata: {
