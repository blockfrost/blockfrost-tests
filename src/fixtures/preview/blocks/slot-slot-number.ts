...
export default [
  {
    id: 'blocks-slot-slot-number-generic-shelley_cfde18e7e318_1',
    testName: 'blocks/slot/:slot_number - generic shelley',
    endpoints: ['blocks/slot/44214148'],
    response: {
      time: 1_710_870_148,
      height: 1_893_053,
  ...
  {
    id: 'blocks-epoch-epoch-number-slot-slot-number-generic-shelley_cfde18e7e318_2',
    testName: 'blocks/epoch/:epoch_number/slot/:slot_number - generic shelley',
    endpoints: ['blocks/epoch/511/slot/63748'],
    response: {
      time: 1_710_870_148,
      height: 1_893_053,
      hash: '1466802be24edd32971c5ca96f6e15a914dc3f79d2cb3e82ec7cd05a16c1b387',
