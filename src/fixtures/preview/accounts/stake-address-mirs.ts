...
const paginationFixtures = getPaginationFixtures(
  'accounts/stake_test1uzg6rdrt4nes96g63jaygvrn777gfnr5wqdr8rq3r6xxtygj4m03u/mirs',
);
...
export default [
  ...paginationFixtures,
  {
    ...
    id: 'accounts-stake-address-mirs-on-chain-account-without-mirs_24a8a072c033',
    testName: 'accounts/:stake_address/mirs - on-chain account without MIRs',
    endpoints: [
      'accounts/stake_test1uzg6rdrt4nes96g63jaygvrn777gfnr5wqdr8rq3r6xxtygj4m03u/mirs',
      'accounts/stake_test1uzg6rdrt4nes96g63jaygvrn777gfnr5wqdr8rq3r6xxtygj4m03u/mirs?order=desc',
      'accounts/stake_test1uzg6rdrt4nes96g63jaygvrn777gfnr5wqdr8rq3r6xxtygj4m03u/mirs?count=1&page=2',
    ],
    response: [],
  },
  {
