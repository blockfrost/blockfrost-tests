...
export default [
  {
    id: 'epochs-number-parameters-generic-shelley-epoch_e61ed742ccaa',
    ...
    response: {
      ...
      nonce: '162d29c4e1cf6b8a84f2d692e67a3ac6bc7851bc3e6e4afe64d15778bed8bd86',
      cost_models: null,
      price_mem: null,
      price_step: null,
      max_tx_ex_mem: null,
  ...
  {
    id: 'epochs-number-parameters-epoch-cost-models-plutus-v1_7ce7f7d7abef',
    testName: 'epochs/:number/parameters epoch - costModels.PlutusV1',
    endpoints: ['epochs/10/parameters'],
    response: {
      epoch: 10,
      min_fee_a: 44,
      min_fee_b: 155_381,
      ...
      min_utxo: '34482',
      min_pool_cost: '340000000',
      nonce: 'e8d2160d3236d209545862350375c449d0ae40456241cd11085652df79fda95d',
      cost_models: {
        PlutusV1: {
  ...
  },
  {
    ...
    response: {
      ...
      min_utxo: '4310',
      min_pool_cost: '340000000',
      nonce: '625c7ab49a7d9320b22520fde133910a57827eeec8624b08e5f5668525e3caeb',
      cost_models: {
        PlutusV1: {
      ...
      cost_models_raw: {
        PlutusV1: [
          ...
          32, 212342, 32, 31220, 32, 32696, 32, 43357, 32, 32247, 32, 38314, 32, 9462713, 1021, 10,
        ],
        PlutusV2: [
          205665, 812, 1, 1, 1000, 571, 0, 1, 1000, 24177, 4, 1, 1000, 32, 117366, 10475, 4, 23000,
          100, 23000, 100, 23000, 100, 23000, 100, 23000, 100, 23000, 100, 100, 100, 23000, 100,
          ...
          38314, 32, 20000000000, 20000000000, 9462713, 1021, 10, 20000000000, 0, 20000000000,
        ],
      },
      price_mem: 0.0577,
      price_step: 0.000_072_1,
