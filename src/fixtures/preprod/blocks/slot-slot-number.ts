...
export default [
  {
    id: 'blocks-slot-slot-number-generic-shelley_1e176fb0721b_1',
    testName: 'blocks/slot/:slot_number - generic shelley',
    endpoints: ['blocks/slot/470160'],
    response: {
      time: 1_656_153_360,
      height: 19_234,
  ...
  {
    id: 'blocks-epoch-epoch-number-slot-slot-number-generic-shelley_1e176fb0721b_2',
    testName: 'blocks/epoch/:epoch_number/slot/:slot_number - generic shelley',
    endpoints: ['blocks/epoch/4/slot/383760'],
    response: {
      time: 1_656_153_360,
      height: 19_234,
      hash: 'cfcefdbe2f849a86d36792a33fd077035eb851b91f09bc3a90e61100709234d9',
