...
export default [
  {
    ...
    endpoints: [
      "addresses/addr_vkh1fj9u7ky4kltke5lzgtrx99kwcfhxezefnzjmq3yrhg7a7u20s6n",
    ],
    response: {
  ...
  },
  {
    ...
    endpoints: [
      "addresses/addr_test1vzpwq95z3xyum8vqndgdd9mdnmafh3djcxnc6jemlgdmswcve6tkw",
    ],
    response: {
      address:
  ...
  },
  {
    ...
    response: {
      ...
      stake_address:
        "stake_test1uzecmpa20ys7csra38deqx0jlsxej59qacuetl58qs3hz9glyc2we",
      type: "shelley",
      script: false,
    },
  },
  {
    ...
    endpoints: [
      "addresses/addr_test1wryc5pv80l9n5kvp27w3rjyq7t7hv0n75wwuny5w40zdqhc2pe2cm",
    ],
    response: {
      address:
        "addr_test1wryc5pv80l9n5kvp27w3rjyq7t7hv0n75wwuny5w40zdqhc2pe2cm",
      amount: expect.arrayContaining([
        { quantity: expect.toBeAssetQuantity(), unit: expect.toBeAssetUnit() },
      ]),
      stake_address: null,
  ...
  },
  {
    ...
    response: {
      ...
      stake_address:
        "stake_test1uq6c5njpqhqg7k0yw7g8q6vu0fe9v6ynxvhes47mfe6zh6cn9uh8x",
      type: "shelley",
      script: false,
    },
  },
  {
    ...
    endpoints: [
      "addresses/addr_vkh1l3j42hfp24eycj7ju4gjy3pcfuq668rs3ux0vqngarjq5me9rqj",
    ],
    response: {
  ...
  },
  {
    ...
    endpoints: [
      "addresses/addr_test1vpwr5sge69n04y5wzm33wc886tta29m24p5420atx6sgf0qrgt5y9",
    ],

    response: {
      address:
        "addr_test1vpwr5sge69n04y5wzm33wc886tta29m24p5420atx6sgf0qrgt5y9",
      amount: expect.arrayContaining([
        { quantity: expect.toBeAssetQuantity(), unit: expect.toBeAssetUnit() },
      ]),
      stake_address: expect.toBeOneOf([expect.toBeStakeAddress(), null]),
  ...
  },
  {
    ...
    endpoints: [
      "addresses/addr_vkh1tsayzxw3vmaf9rskuvtkpe7j6l23w64gd92nl2ek5zztctwelcp",
    ],
  ...
  },
  {
    ...
    response: {
      ...
      stake_address:
        "stake_test1uzl969fay6sf66gjvluwe5vgq3ge20j8x0le0t7p0c6cp5qz4hevm",
      type: "shelley",
      script: false,
    },
  },
  ...
  },
  {
    ...
    endpoints: [
      "addresses/addr_vkh1j6uegzwrsnt78n4cryg2sepya4ju3w9dxzyu4spv7j7p2ax4w2q",
    ],
  ...
  },
  {
    ...
    response: {
      ...
      stake_address:
        "stake_test1uqesewrdrc2f3k447q5pqd88yran6mpuc64lsr44f4fn8qgawfk0n",
      type: "shelley",
      script: false,
    },
  },
