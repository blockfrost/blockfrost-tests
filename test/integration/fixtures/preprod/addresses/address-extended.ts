export default [
  ...
  },
  {
    ...
    endpoints: [
      "addresses/addr_vkh1fj9u7ky4kltke5lzgtrx99kwcfhxezefnzjmq3yrhg7a7u20s6n/extended",
    ],
  ...
  {
    testName:
      "addresses/:address/extended Blockfrost RFT asset (v1) with CIP68 metadata",
    endpoints: [
    ...
    response: {
      ...
      stake_address:
        "stake_test1urxxy5zkf5l4plqcz6aqv5nghzhgtcpr8sm33qr6nal4hfqgxqlrt",
      type: "shelley",
      script: false,
    },
  },
