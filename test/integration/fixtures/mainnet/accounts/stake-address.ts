...
export default [
  ...paginationFixtures,
  {
    ...
    endpoints: [
      "accounts/stake1u9uz4j024qfud557ucrqw3kqfdndjgaxj7m44x7tamkvmyqzdwe7v",
    ],
    response: {
      stake_address:
  ...
  },
  {
    ...
    endpoints: [
      "accounts/stake1u9fzg77vrgfqlplkjqe9hntdcvsurpvxd60yp2fhn73002qsv9pdk",
    ],
  ...
  */
  {
    ...
    endpoints: [
      "accounts/stake1uyluup0rh6r2cc7kcw8nudqz990ezf5ltagxmw3u8deukvqwq7etq",
    ],
  ...
  {
    testName:
      "accounts/:stake_address reward account for 2 pools deregistered pools",

    endpoints: [
      "accounts/stake1u8fne2lfh3a8v33y8splqc5gr5r8gjea2wvrsgch39emnvqny8wlm",
    ],

    response: {
      stake_address:
        "stake1u8fne2lfh3a8v33y8splqc5gr5r8gjea2wvrsgch39emnvqny8wlm",
      active: true,
      active_epoch: 208,
      controlled_amount: "0",
      drep_id: null,
  ...
  {
    testName:
      "accounts/:stake_address reward account for pool deregistered 2 times",

    endpoints: [
      "accounts/stake1uxzjdz34g596yt9dyprjse0yr775xszuyal3ltyqsx2k9wcjhvvke",
    ],
  ...
  },
  {
    ...
    endpoints: [
      "accounts/stake1u80x0vdf8kwvptk7nar24d805p7wnlj4vm22cl0q8jngs9q5k2suq",
    ],
  ...
  // registered drep
  {
    ...
    endpoints: [
      "accounts/stake1ux3dy2p970cv2lsqvl4nqxwj7c878tgs6a6h9yekk3pr27g70l5g4",
    ],

    response: {
      stake_address:
        "stake1ux3dy2p970cv2lsqvl4nqxwj7c878tgs6a6h9yekk3pr27g70l5g4",
      active: false,
      active_epoch: 508,
  ...
  },
  {
    ...
    endpoints: [
      "accounts/stake1uygt23qnfwel5y6vl65mlzwzjf6wvjflnp3k23fj6l4qwngdjy4yn",
    ],

    response: {
      stake_address:
        "stake1uygt23qnfwel5y6vl65mlzwzjf6wvjflnp3k23fj6l4qwngdjy4yn",
      active: true,
      active_epoch: 313,
      controlled_amount: expect.toBeAdaQuantity(),
  ...
  },
  {
    ...
    endpoints: [
      "accounts/stake1u9ng9m2wvcldpryt860hr29gflr3y9nh72k4k6h3dzu36pqprkt36",
    ],

    response: {
      stake_address:
        "stake1u9ng9m2wvcldpryt860hr29gflr3y9nh72k4k6h3dzu36pqprkt36",
      active: expect.any(Boolean),
