export default [
  ...
  },
  {
    ...
    endpoints: [
      "addresses/addr_vkh13jtsh5u0um0p3jz2w5xamhe4kr52x8f5gyfvw5wqg90f57gkgmc/extended",
    ],
  ...
  },
  {
    ...
    response: {
      ...
      stake_address:
        "stake1uxdzddagsjd33wr0at84s24uvj7kdh6hrxfdwjpgdfkr8acsmkrf5",
      type: "shelley",
      script: false,
    },
  },
  {
    ...
    response: {
      ...
      stake_address:
        "stake1u9x5ka8nd5k3pdgqrc5kfxj5mkt93037p8xy7sppahyy0dc44jtzm",
      type: "shelley",
      script: false,
    },
  },
  {
    // play electric luxury gap off huge put correct sword digital whisper display
    testName:
      "addresses/:address/extended Blockfrost RFT asset with CIP68v2 metadata (decimals)",
    endpoints: [
    ...
    response: {
      ...
      stake_address:
        "stake1u9nfu3aj60ajs73g05g886s0g7mwlaqcvtust3ndcfvf6uspqcftm",
      type: "shelley",
      script: false,
    },
  },
