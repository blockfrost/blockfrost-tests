...
export default [
  ...
  {
    testName:
      "accounts/:stake_address/addresses/assets - generic stake address without tokens",
  ...
  {
    testName:
      "accounts/:stake_address/addresses/assets - valid not on-chain account",
